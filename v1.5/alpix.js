...
theme.lang.footerTitle3 = "Categorias";
theme.lang.footerTitle2 = "Pagamento e Segurança";
theme.lang.footerTitle4 = "#COMUNIDADEPAPELÔ<br>RECEBA NOVIDADES E OFERTAS EXCLUSIVAS NO SEU E-MAIL";
...
theme.build.header = function(template){
    ...
    $('#theme_header-functions').prepend('<li><a href="https://wa.me/55'+ theme.storeWhatsapp +'" target="_blank" class="header-item">'+ theme.icon.chat +'<div><b>Precisa de ajuda?</b>Clique aqui</div></a></li>');
...
theme.build.footer = function(template){
    ...
    $('#theme_footer-payments').append(theme.footerSeals);
    

    $('#rodape .selos').find('.titulo').remove();
    $('#rodape .selos').attr('class','selos');

    $('#theme_footer-contact').prepend('<div class="contact"><i><svg id="Hand-drawn_Icon_Set" data-name="Hand-drawn Icon Set" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35.01 24.3"><defs><style>.cls-1{fill:none;stroke:#ff7bac;stroke-miterlimit:10;stroke-width:0.75px;}</style></defs><polygon class="cls-1" points="23.09 12.33 34.64 19.63 34.64 4.72 23.09 12.33"/><polygon class="cls-1" points="0.38 4.72 0.38 19.63 11.93 12.33 0.38 4.72"/><path class="cls-1" d="M2198.5,1222.56h-30a2.1,2.1,0,0,0-2.07,1.82l17.06,11.24,17.07-11.24A2.11,2.11,0,0,0,2198.5,1222.56Z" transform="translate(-2166.01 -1222.18)"/><path class="cls-1" d="M2187.13,1235.8l-3,2a1,1,0,0,1-.59.18,1.07,1.07,0,0,1-.59-.18l-3-2-13.44,8.5a2.12,2.12,0,0,0,2.07,1.81h30a2.1,2.1,0,0,0,2.07-1.81Z" transform="translate(-2166.01 -1222.18)"/></svg></i><div><small>Fale via e-mail</small><a href="mailto:'+ theme.storeMail +'" target="_blank">'+ theme.storeMail +'</a></div></div>');
    if(theme.storeWhatsapp){    
        $('#theme_footer-contact').prepend('<div class="contact"><i><svg id="Hand-drawn_Icon_Set" data-name="Hand-drawn Icon Set" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.11 31.12"><defs><style>.cls-1{fill:#18aa92;}</style></defs><path class="cls-1" d="M2189.64,1161.24l-2.39-1.83a2,2,0,0,0-2.69.18l-.94.93a4.84,4.84,0,0,1-1.93-1l-.09-.07a5.28,5.28,0,0,1-.62-.63l-.07-.08a4.76,4.76,0,0,1-1-1.94l.93-.93a2.06,2.06,0,0,0,.18-2.69l-1.83-2.39a2.14,2.14,0,0,0-2.57-.66l-.27.12a4.49,4.49,0,0,0-2.68,4,11.94,11.94,0,0,0,2.79,7.9l.12.15a13.55,13.55,0,0,0,1.52,1.51l.15.13a11.91,11.91,0,0,0,7.66,2.79h.25a4.48,4.48,0,0,0,4-2.69l.12-.27A2.13,2.13,0,0,0,2189.64,1161.24Zm-.79,1.93h0l-.12.27a2.88,2.88,0,0,1-2.59,1.73h-.22a10.33,10.33,0,0,1-6.64-2.41l-.14-.13a10.37,10.37,0,0,1-1.33-1.32l-.12-.15a10.32,10.32,0,0,1-2.42-6.86,2.91,2.91,0,0,1,1.73-2.59l.28-.12a.54.54,0,0,1,.67.18l1.83,2.38a.47.47,0,0,1,0,.62l-1.23,1.23a.8.8,0,0,0-.22.69,6.39,6.39,0,0,0,1.41,3.09l.07.08a6.28,6.28,0,0,0,.82.81l.08.07a6.46,6.46,0,0,0,3.08,1.42.79.79,0,0,0,.69-.22l1.23-1.24a.48.48,0,0,1,.62,0l2.39,1.83A.56.56,0,0,1,2188.85,1163.17Z" transform="translate(-2166.53 -1142.8)"/><path class="cls-1" d="M2193.09,1147.36a15.55,15.55,0,0,0-26.45,9.17,15.62,15.62,0,0,0,1.9,9.49l-1.31,4.52a2.15,2.15,0,0,0,1.47,2.68,2.26,2.26,0,0,0,1.21,0l4.52-1.31a15.56,15.56,0,0,0,18.66-24.55Zm-1.12,20.89a14,14,0,0,1-17,2.13.74.74,0,0,0-.63-.08l-4.84,1.4a.58.58,0,0,1-.72-.4.44.44,0,0,1,0-.32l1.4-4.84a.82.82,0,0,0-.08-.63,14,14,0,1,1,21.9,2.74Z" transform="translate(-2166.53 -1142.8)"/></svg></i><div><small>Fale via whatsapp</small><a href="https://wa.me/55'+ (theme.storeWhatsapp.replaceAll('(','').replaceAll(')','').replaceAll('-','').replaceAll(' ','')) +'" target="_blank">'+ theme.storeWhatsapp +'</a></div></div>');
    }

    $('#theme_footer-social').append('<p>'  + theme.storeOperationTime + '</p>');
    $('#theme_footer-social').append(theme.socialIcons);

    $.each(theme.customSocial, function(k_, i_){
        $('#theme_footer-social').append('<a href="'+ i_.link +'" target="_blank"><span>'+ i_.icon +'</span></a>');
    });

    $('#theme_footer-social a').wrapAll('<div></div>');

    $('#theme_footer-testimonials').append('<div><i class="fa fa-heart"></i><strong>Depoimentos</strong><small>Confira o que nossos clientes estão comentando</small><a href="/pagina/depoimentos.html">Clique Aqui</a></div>')
    $('#barraNewsletter.posicao-rodape .texto-newsletter').html(theme.lang.footerTitle4);
    $('#barraNewsletter.posicao-rodape > .conteiner > .row-fluid > .span').toggleClass('span col');
    $('#barraNewsletter.posicao-rodape > .conteiner > .row-fluid').toggleClass('row-fluid row-flex');
    $('#barraNewsletter.posicao-rodape > .conteiner > .row-flex').prepend('<div class="col-auto"><img src="https://cdn.awsli.com.br/2516/2516405/arquivos/bot-logo.svg" alt="Texto alternativo para a imagem" ></div>');
...
theme.functions.WS_load = function(){
    ...
    $('.listagem-item').each(function(){
        ...
        let info = WS_PAPELO.find(el => el.product_id == id);
        if(info){
            if(info.brand.length > 0){
                me.find('.info-produto').prepend('<b class="theme_brand">'+ info.brand +'</b>');
            }
            if(info.excerpt.length > 0){
                me.find('.info-produto').append('<p class="theme_excerpt">'+ info.excerpt +'</p>');
            }
            if(info.labels.length > 0){
                me.find('.imagem-produto').append('<div class="theme_labels"></div>');
                if(info.labels.includes(';')){
                    $.each(info.labels.split(';'), function(k, i){
                        me.find('.theme_labels').append('<div>'+ i +'</div>');    
                    })
                }else{
                    me.find('.theme_labels').append('<div>'+ item.labels +'</div>');
                }
            }
        }
    })
...
theme.functions.unflexBanners = function(){
    $('.secao-banners .cheio .flexslider').each(function(){
        theme.functions.flexDestroy_withStyle($(this).closest('.flexslider'));
    })
        ...
        if(trigger.includes('[banner-texto]')){
         ...
         if(trigger.includes('[item-categoria]')){
            if($('#theme_categorySlider').length == 0){
                $('<div id="theme_categorySlider"><div class="slider-categorias"></div><div class="slides"></div></div>').prependTo('#corpo > .conteiner');
            }
...
theme.templates = [];
theme.storeMail = "papelo.store@gmail.com";
theme.storeOperationTime = "Segunda a Sexta<br>9h às 17h";
theme.functions.init = function(){
    ...
    theme.icon = {};
    theme.icon.chat = '<svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19 37L1 37V19C1 9.064 9.064 1 19 1C28.936 1 37 9.064 37 19C37 28.936 28.936 37 19 37Z" stroke="#18AA92" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M28.054 21.7C29.5452 21.7 30.754 20.4912 30.754 19C30.754 17.5088 29.5452 16.3 28.054 16.3C26.5628 16.3 25.354 17.5088 25.354 19C25.354 20.4912 26.5628 21.7 28.054 21.7Z" stroke="#18AA92" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/><path d="M18.946 21.7C20.4372 21.7 21.646 20.4912 21.646 19C21.646 17.5088 20.4372 16.3 18.946 16.3C17.4548 16.3 16.246 17.5088 16.246 19C16.246 20.4912 17.4548 21.7 18.946 21.7Z" stroke="#18AA92" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/><path d="M9.946 21.7C11.4372 21.7 12.646 20.4912 12.646 19C12.646 17.5088 11.4372 16.3 9.946 16.3C8.45483 16.3 7.246 17.5088 7.246 19C7.246 20.4912 8.45483 21.7 9.946 21.7Z" stroke="#18AA92" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/></svg>';
    ...
    theme.icon.cart = '<svg width="34" height="38" viewBox="0 0 34 38" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M23.188 7.75V9.964H10.3356V7.75C10.3356 4.024 13.2247 1 16.7618 1C18.5303 1 20.1588 1.756 21.3144 2.98C22.4701 4.222 23.188 5.896 23.188 7.768V7.75Z" stroke="#2352A2" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/><path d="M30.297 17.65H3.22638L3.71666 15.094C4.2945 12.088 6.34318 9.98201 8.70705 9.98201H24.7989C27.1627 9.98201 29.2114 12.088 29.7892 15.094L30.2795 17.65H30.297Z" stroke="#2352A2" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/><path d="M27.3904 37H6.13309C2.78866 37 0.33724 32.878 1.16022 28.612L3.22641 17.668H30.2796L32.3458 28.612C33.1512 32.878 30.6998 37 27.3729 37H27.3904Z" stroke="#2352A2" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/><path d="M10.4932 26.992H23.0304" stroke="#2352A2" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/></svg>';
    ...
    theme.icon.search = '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.297 14.6145C11.1624 15.3321 9.81455 15.7394 8.3794 15.7394C4.29697 15.7491 1 12.4424 1 8.3697C1 4.29697 4.29697 1 8.3697 1C12.4424 1 15.7394 4.29697 15.7394 8.3697C15.7394 9.79515 15.3321 11.1333 14.6339 12.2582" stroke="#FFC72F" stroke-linecap="round" stroke-linejoin="round"/><path d="M11.8412 11.8412L17 17" stroke="#FFC72F" stroke-miterlimit="10" stroke-linecap="round"/></svg>';
    theme.icon.account = '<svg width="31" height="38" viewBox="0 0 31 38" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.4 13.312C18.77 13.312 21.502 10.5559 21.502 7.156C21.502 3.75614 18.77 1 15.4 1C12.0299 1 9.29797 3.75614 9.29797 7.156C9.29797 10.5559 12.0299 13.312 15.4 13.312Z" stroke="#FE676B" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/><path d="M6.976 34.174C6.04 34.03 5.176 33.832 4.402 33.562C2.746 32.968 1.54 31.996 1.162 30.394C1.036 29.728 1 29.08 1 28.396C1 20.404 7.462 13.906 15.4 13.906C23.338 13.906 29.8 20.404 29.8 28.414C29.8 29.098 29.764 29.746 29.638 30.412C28.702 34.894 19.072 34.498 13.6 34.498" stroke="#FE676B" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/><path d="M10.486 37V29.764" stroke="#FE676B" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/></svg>';
    ...
    theme.templates.footer = '<div class="conteiner"> <div class="row-flex justify-content-between"> <div class="col-auto" id="theme_footer-contact"> </div><div class="col-auto" id="theme_footer-social"> </div><div class="col-auto" id="theme_footer-pages"> <h4>'+ theme.lang.footerTitle1 +'</h4> </div><div class="col-auto" id="theme_footer-testimonials"> </div></div><div class="row-flex"> <div class="col-auto" id="theme_footer-tracking"> <h4>Rastreie sua Encomenda</h4> <div> <input type="text"> <button type="button"><i class="fa fa-search"></i></button> </div></div><div class="col-auto" id="theme_footer-payments"> <h4>'+ theme.lang.footerTitle2 +'</h4> </div></div></div>';
...
theme.functions['pagina-produto'] = function(){
    ...
    if($('.thumbs-vertical').length > 0){
        theme.functions.flexDestroyTotal($('.thumbs-vertical #carouselImagem'));
    ...
    if($('.thumbs-horizontal').length > 0){
        theme.functions.flexDestroyTotal($('.thumbs-horizontal'));
...
theme.functions.flexDestroyTotal = function(oObj){
    console.log(oObj);
    var $els = $(oObj);
    $els.each(function() {
        var $el = $(this);
